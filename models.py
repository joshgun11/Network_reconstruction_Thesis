...
# Regression MLP
class REG(nn.Module):
    def __init__(self,in_size,n_hidden1,n_hidden2,n_hidden3,n_hidden4,n_hidden5,
    n_hidden6,n_hidden7,out_size):
...
class LSTM():
    ...
    def LSTM_classification(self,n_steps,node_size,num_classes):
        ...
        model.add(keras.layers.LSTM(100,activation = "relu",return_sequences = False,
        input_shape=(n_steps, (node_size-1)*num_classes)))
    ...
    def LSTM_regression(self,n_steps,node_size,num_classes):
        ...
        model = keras.models.Sequential()
        model.add(keras.layers.LSTM(100,activation = "relu",return_sequences = False,
        input_shape=(n_steps, node_size-1)))
        model.add(keras.layers.Dense(32,activation = "relu"))
        model.add(keras.layers.Dense(16, activation = "relu"))
